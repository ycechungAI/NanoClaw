...
## P0 - Critical
- [ ] Fix unregistered-chat trigger pipeline mismatch
...
## P1 - High
- [ ] Split `src/index.ts` into dedicated services
...
- [ ] Reduce polling + synchronous I/O in hot paths
...
## P0 - Critical
- [ ] Eliminate sync config reads in hot message paths
...
- [ ] Add missing composite indexes for message query patterns
...
## P1 - High
- [ ] Replace polling-heavy loops with event-driven flow where feasible
...
- [ ] Remove repeated container startup filesystem churn
...
- [ ] Stop rewriting full task/group snapshots on every run
...
## P2 - Medium
- [ ] Add queue backpressure and `O(1)` queue primitives
...
- [ ] Optimize dashboard data access and API caching
...
- [ ] Tighten container resource defaults and log retention
